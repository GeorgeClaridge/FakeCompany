...
const Plan = () => {
  return (
    <div className='grid grid-cols-1 gap-12 lg:grid-cols-3 bg-green px-2 md:px-20 xl:px-60 py-10 md:py-20 bg-no-repeat bg-bottom'  style={{ backgroundImage: `url(${Background})` }} >
